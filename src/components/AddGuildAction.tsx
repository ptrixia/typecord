...
export default function AddGuildAction() {
  ...
  /*
   * Lógica para entrar em uma guild
   */
  ...
  /*
   * Gera o título do modal.
   */
  const getModalTitle = () => {
    switch (modalStep) {
      case "create":
        return "Personalize sua guild";
      case "join":
        return "Entrar em uma guild";
      default:
        return "Crie sua guild";
    }
  };
        ...
        {modalStep === "options" && (
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <button type="button" onClick={() => setGuildName("Guild Gamer")} className="group flex w-full items-center gap-4 rounded-lg border border-zinc-200 bg-zinc-50 px-4 py-3 text-left transition-all hover:bg-zinc-100 dark:border-zinc-700 dark:bg-zinc-900 dark:hover:bg-zinc-800">
                <Gamepad2 className="h-5 w-5 text-indigo-500" />
                <span className="flex-1 text-sm font-medium text-zinc-700 dark:text-zinc-300">Gaming</span>
                <ArrowRight className="h-4 w-4 text-zinc-400" />
              </button>
              <button type="button" onClick={() => setGuildName("Guild dos Amigos")} className="group flex w-full items-center gap-4 rounded-lg border border-zinc-200 bg-zinc-50 px-4 py-3 text-left transition-all hover:bg-zinc-100 dark:border-zinc-700 dark:bg-zinc-900 dark:hover:bg-zinc-800">
                <Heart className="h-5 w-5 text-pink-500" />
                <span className="flex-1 text-sm font-medium text-zinc-700 dark:text-zinc-300">Amigos</span>
                <ArrowRight className="h-4 w-4 text-zinc-400" />
              </button>
              <button type="button" onClick={() => setGuildName("Grupo de Estudos")} className="group flex w-full items-center gap-4 rounded-lg border border-zinc-200 bg-zinc-50 px-4 py-3 text-left transition-all hover:bg-zinc-100 dark:border-zinc-700 dark:bg-zinc-900 dark:hover:bg-zinc-800">
                <GraduationCap className="h-5 w-5 text-emerald-500" />
                <span className="flex-1 text-sm font-medium text-zinc-700 dark:text-zinc-300">Grupo de estudos</span>
                <ArrowRight className="h-4 w-4 text-zinc-400" />
              </button>
            </div>
            ...
            <div className="mt-4 border-t border-zinc-200 pt-4 dark:border-zinc-800">
              ...
              <button type="button" onClick={() => setModalStep("join")} className="flex w-full items-center justify-center gap-2 rounded-md bg-zinc-900 px-4 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-zinc-800 dark:bg-zinc-800 dark:hover:bg-zinc-700">
        ...
        {modalStep === "create" && (
          <div className="space-y-5">
            ...
            <div className="flex justify-center">
              <button type="button" className="group relative flex h-24 w-24 items-center justify-center rounded-full border-2 border-dashed border-zinc-400 bg-zinc-100 transition-colors hover:border-indigo-500 hover:bg-zinc-200 dark:border-zinc-700 dark:bg-zinc-900 dark:hover:border-indigo-400 dark:hover:bg-zinc-800">
                <div className="text-center">
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                onKeyDown={(event) => { if (event.key === "Enter") { handleCreateGuild(); } }}
              ...
              <p className="text-xs text-zinc-400 dark:text-zinc-500">
                Ao criar uma guild, você poderá adicionar canais e convidar seus amigos.
              </p>
            </div>
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                onKeyDown={(event) => { if (event.key === "Enter") { handleJoinGuild(); } }}
                placeholder="https://typecord.com/convite/abc123"
                autoFocus
                className="h-11 w-full rounded-md border border-zinc-300 bg-white px-3 text-sm text-zinc-900 outline-none transition-all placeholder:text-zinc-400 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100 dark:placeholder:text-zinc-600"
              />
              <p className="text-xs text-zinc-500 dark:text-zinc-500">
                Os convites normalmente têm este formato:
              </p>
            ...
            <div className="flex items-center gap-3 rounded-lg border border-emerald-200 bg-emerald-50 p-3 dark:border-emerald-900/40 dark:bg-emerald-950/20">
              ...
              <div className="min-w-0">
                ...
                <p className="mt-0.5 text-xs text-zinc-500 dark:text-zinc-500">Peça ao administrador da guild para enviar um link de convite.</p>
              </div>
            </div>
